...
//
//
//public class CMSChecker extends BaseListActivity
//        implements CMSCheckerPresenter.ClView {
//
//    private CMSCheckerPresenter presenter;
//
//    private static final String KEY_ARG_ID = CMSChecker.class.getSimpleName();
//
//    private ActivityCheckhostBinding binding;
//
//    public static Intent newInstance(Context context, String content) {
//        Intent intent = new Intent(context, CMSChecker.class);
...
//        presenter = new CMSCheckerPresenter(this, this, handler);
//
