...
//import com.walhalla.whatismyipaddress.Tools;
...
//
//
//public class CloudFlareBypass extends BaseListActivity
//        implements CloudFlareBypassPresenter.ClView {
//
//    private CloudFlareBypassPresenter presenter;
//
//    private static final String KEY_ARG_ID = CloudFlareBypass.class.getSimpleName();
//
//    private ActivityCheckhostBinding binding;
//
//    public static Intent newInstance(Context context, String content) {
//        Intent intent = new Intent(context, CloudFlareBypass.class);
...
//        presenter = new CloudFlareBypassPresenter(this, this, handler);
//
...
////                    }
//
//                    presenter.bypassCloudFlare(HOSTNAME);
//                } else {
