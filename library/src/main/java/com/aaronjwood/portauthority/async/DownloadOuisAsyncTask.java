...
public class DownloadOuisAsyncTask extends DownloadAsyncTask {
    ...
    private static final String SERVICE = "https://whatismyipaddress-e16fb.web.app/manuf";
     ...
     * @param activity
     */
    public DownloadOuisAsyncTask(Database0 database, Parser parser, MainAsyncResponse activity) {
        db = database;
    ...
    protected void onPostExecute(Void result) {
        ...
        if (activity != null) {
            ((OuisListener) activity).setupMac();
        }
    }

    public interface OuisListener {
