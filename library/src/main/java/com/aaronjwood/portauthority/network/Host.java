...
public class Host implements Serializable {
    ...
    public Host(String ip, String mac, Database0 db) throws UnknownHostException {
        this(ip, mac);
        setVendor(db);
    }
    ...
    private void setVendor(Database0 db) {
     ...
     */
    public static String findMacVendor(String mac, Database0 db) throws SQLiteException {
