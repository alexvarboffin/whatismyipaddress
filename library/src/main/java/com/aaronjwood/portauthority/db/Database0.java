...
public class Database0 extends SQLiteOpenHelper {
    ...
    private static Database0 singleton;
     ...
     * @return
     */
    public static Database0 getInstance(Context context) {
        if (singleton == null) {
            singleton = new Database0(context);
        }
     ...
     * @param context
     */
    private Database0(Context context) {
